...
public class RemoveFromFavoritesAction extends Action {
    ...
    public RemoveFromFavoritesAction(JTree tree) {
        super("Remove from favorites", null, "Remove selected files from favorites",
                KeyEvent.VK_M, KeyEvent.VK_H);
        this.tree = tree;
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        removeFromFavorites(files);
    }

    private void removeFromFavorites(List<String> files) {
        ...
        try {
            ...
            files.forEach(newFavorites::remove);
