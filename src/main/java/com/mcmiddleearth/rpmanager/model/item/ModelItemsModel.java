...
import com.mcmiddleearth.rpmanager.json.adapters.TintListJsonAdapter;
import com.mcmiddleearth.rpmanager.model.item.tint.Tint;

import java.util.List;

public class ModelItemsModel extends ItemsModel {
    private String model;
    @JsonAdapter(TintListJsonAdapter.Factory.class)
